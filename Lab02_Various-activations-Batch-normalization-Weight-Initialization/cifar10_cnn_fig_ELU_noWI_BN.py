...
if not data_augmentation:
    ...
    #save reult to txt
    pickle.dump( train_loss, open( "train_loss_ELU_noWI_BN.txt", "wb" ) )
    pickle.dump( train_acc, open( "train_acc_ELU_noWI_BN.txt", "wb" ) )
    pickle.dump( val_loss, open( "val_loss_ELU_noWI_BN.txt", "wb" ) )
    pickle.dump( val_acc, open( "val_acc_ELU_noWI_BN.txt", "wb" ) )
    ...
    plt.xlabel('#Epoch')
    plt.ylabel('Loss')
    plt.savefig('fig-NIN-loss_ELU_noWI_BN.png', dpi=1200)
    ...
    plt.xlabel('#Epoch')
    plt.ylabel('Loss')
    plt.savefig('fig-NIN-acc_ELU_noWI_BN.png', dpi=1200)
