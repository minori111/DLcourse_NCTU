...
if not data_augmentation:
    ...
    #save reult to txt
    pickle.dump( train_loss, open( "train_loss_elu.txt", "wb" ) )
    pickle.dump( train_acc, open( "train_acc_elu.txt", "wb" ) )
    pickle.dump( val_loss, open( "val_loss_elu.txt", "wb" ) )
    pickle.dump( val_acc, open( "val_acc_elu.txt", "wb" ) )
