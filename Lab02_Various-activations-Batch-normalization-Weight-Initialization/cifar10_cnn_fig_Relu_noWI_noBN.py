...
if not data_augmentation:
    ...
    #save reult to txt
    pickle.dump( train_loss, open( "train_loss_Relu_noWI_noBN.txt", "wb" ) )
    pickle.dump( train_acc, open( "train_acc_Relu_noWI_noBN.txt", "wb" ) )
    pickle.dump( val_loss, open( "val_loss_Relu_noWI_noBN.txt", "wb" ) )
    pickle.dump( val_acc, open( "val_acc_Relu_noWI_noBN.txt", "wb" ) )
    ...
    plt.xlabel('#Epoch')
    plt.ylabel('Loss')
    plt.savefig('fig-NIN-loss_Relu_noWI_noBN.png', dpi=1200)
    ...
    plt.xlabel('#Epoch')
    plt.ylabel('Loss')
    plt.savefig('fig-NIN-acc_Relu_noWI_noBN.png', dpi=1200)
